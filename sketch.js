...
function draw() {
  ...
  push()
    ...
    ellipse(0+m_x/20,0+m_y/80,400)  
    
    
    fill(0)
    ellipse(-70+m_x/20,-70+m_y/80,70)
    noFill()
    
    fill(0)
    ellipse(70+m_x/20,-90+m_y/80,70)
    
    fill(245,0,0)
    triangle(0+m_x/20,0+m_y/80,200,00,0,90)
    fill(255)

    fill(255)
    ellipse(-50+m_x/20,110+m_y/80,90)
